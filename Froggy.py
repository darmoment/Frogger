...
#Frogg
IMAGE = pygame.image.load('Frogger.png').convert_alpha()
GREEN = pygame.image.load('GreenCar.png').convert_alpha() #CARS
BLUE = pygame.image.load('BlueCar.png').convert_alpha() #CARS
RED = pygame.image.load('RedCar.png').convert_alpha() #CARS
LOG = pygame.image.load('Log.png').convert_alpha() 
LILYPAD = pygame.image.load('LilyPad.png').convert_alpha()
BUSH = pygame.image.load('Bush.png')
COIN = pygame.image.load('Coin.png')
FROGLIFE = pygame.image.load('FroggerLife.png') #LIFE ICON
...
def main():
    ...
    while start:
        ...
        gameTitle = pygame.font.Font('8-bit-hud.ttf', 32)
        gameStart = pygame.font.Font('8-bit-hud.ttf', 24)
        text1 = gameTitle.render(' FROGGER! ', True, green, blue)
        text2 = gameStart.render(' Press SPACE to Play! ', True, green, blue)
        text1Rect = text1.get_rect()
        text2Rect = text2.get_rect()
        text1Rect.center = (370, 258)
        text2Rect.center = (370, 322)
        surface.fill(white)
    ...
    while lost:
        ...
        text3 = gameLost.render(' YOU LOST ', True, green, blue)
        text4 = gameRestart.render(' Press SPACE ', True, green, blue)
        text5 = gameRestart2.render(' to play again! ', True, green, blue)
    ...
    while won: 
        ...
        gameRestart2 = pygame.font.Font('8-bit-hud.ttf', 28)
        text1 = gameWon.render(' YOU WON! ', True, green, blue)
        text2 = finalCoins.render(' with ' + str(coinCounter) + ' coins! ', True, green, blue)
        text3 = gameRestart1.render(' Press SPACE ', True, green, blue)
        text4 = gameRestart2.render(' to play again! ', True, green, blue)
        text1Rect = text1.get_rect()
        text2Rect = text2.get_rect()
        text3Rect = text3.get_rect()
        text4Rect = text4.get_rect()
